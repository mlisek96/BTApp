...
import './TableTransportationTable.scss'
...
export function TableTransportationTable() {
    ...
    return (
        <ScrollArea style={{ height: 300 }} onScrollPositionChange={({y}) => setScrolled(y !== 0)}>
            <Table className='TableTransportationTable'>
                <thead className={cx('TableTransportationTable-thead', {[classes.scrolled]: scrolled})}>
                <tr>
                    <th>Amount</th>
                    <th>Description</th>
                    <th></th>
