...
import './TableDinningOutTable.scss'
...
export function TableDinningOutTable() {
    ...
    return (
        <ScrollArea style={{ height: 300 }} onScrollPositionChange={({y}) => setScrolled(y !== 0)}>
            <Table className='TableDinningOutTable'>
                <thead className={cx('TableDinningOutTable-thead', {[classes.scrolled]: scrolled})}>
                <tr>
                    <th>Amount</th>
                    <th>Description</th>
                    <th></th>
