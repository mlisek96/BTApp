...
import './TableGroceriesTable.scss'
...
export function TableGroceriesTable() {
    ...
    return (
        <ScrollArea style={{ height: 300 }} onScrollPositionChange={({y}) => setScrolled(y !== 0)}>
            <Table className='TableGroceriesTable'>
                <thead className={cx('TableGroceriesTable-thead', {[classes.scrolled]: scrolled})}>
                <tr>
                    <th>Amount</th>
                    <th>Description</th>
                    <th></th>
